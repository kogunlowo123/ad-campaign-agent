"""Ad Campaign Agent - Domain-Specific Connectors."""
...
class HubspotMarketingConnector:
    """Domain-specific connector for hubspot marketing integration with Ad Campaign Agent."""
...
class MarketoConnector:
    """Domain-specific connector for marketo integration with Ad Campaign Agent."""
...
class MailchimpConnector:
    """Domain-specific connector for mailchimp integration with Ad Campaign Agent."""
...
class GoogleAnalyticsConnector:
    """Domain-specific connector for google analytics integration with Ad Campaign Agent."""
...
class MetaAdsConnector:
    """Domain-specific connector for meta ads integration with Ad Campaign Agent."""
