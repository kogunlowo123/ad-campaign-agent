"""Ad Campaign Agent - Main Agent Implementation."""
...
class AdCampaignAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "create_ad_copy": self.tools.create_ad_copy,
            "manage_budget": self.tools.manage_budget,
            "optimize_targeting": self.tools.optimize_targeting,
            "analyze_performance": self.tools.analyze_performance,
            "generate_roi_report": self.tools.generate_roi_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['ad', 'campaign', 'analytics', 'optimization'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "create_ad_copy": ['create', 'ad', 'copy'],
            "manage_budget": ['manage', 'budget'],
            "optimize_targeting": ['optimize', 'targeting'],
            "analyze_performance": ['analyze', 'performance'],
            "generate_roi_report": ['generate', 'roi', 'report'],
        }
